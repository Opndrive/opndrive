      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          <div className="flex-1 overflow-y-auto overflow-x-hidden py-4 px-3">
            ...
            <button
              onClick={handleBack}
              className="flex items-center cursor-pointer w-full px-4 py-3 mb-4 text-sm font-medium bg-card text-card-foreground border border-border rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 hover:bg-accent hover:text-foreground"
            >
